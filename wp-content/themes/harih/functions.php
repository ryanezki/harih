...
add_action('wp_enqueue_scripts', function () {
    ...
    $is_hybrid   = is_page_template('page-harga-hybrid.php') || is_page_template('page-satuan.php') || is_page_template('page-upsell.php') || is_page_template('page-proof.php') || is_page_template('page-tamu.php');
...
function harih_halaman_utilitas(): array {
    ...
    foreach (['isi-data', 'upsell', 'satuan', 'proof', 'tamu'] as $slug) {
