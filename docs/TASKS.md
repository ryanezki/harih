...
- [ ] **T1.5** FluentSMTP → Brevo untuk email bawaan WooCommerce (§4) → plugin terpasang; **sisa: sambungkan akun Brevo via wp-admin (aksi owner)**
