...
5. Setelahnya: review runbook (`docs/runbook.md`) oleh owner, keputusan masa aktif (T3.13), template email Brevo (T2.5), musik library (T1.15), tema #2–#3 (T3.5), aset cover/og:image default (sisa T1.13).
